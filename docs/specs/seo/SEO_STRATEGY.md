...
```json
{
  ...
  "@type": "WebApplication",
  "name": "{Tool Name}",
  "url": "https://www.toolforge.website/tools/{slug}",
...
### URL Structure
```
https://www.toolforge.website/                        ← Homepage
https://www.toolforge.website/tools/image-compressor  ← Tool page
https://www.toolforge.website/tools/qr-generator      ← Tool page
https://www.toolforge.website/category/image          ← Category page (Phase 4)
https://www.toolforge.website/blog/how-to-compress-images ← Blog (Phase 4)
```
