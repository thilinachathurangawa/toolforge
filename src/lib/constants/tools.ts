...
export const TOOLS: Tool[] = [
...

  {
    slug: 'image-resizer',
    name: 'Image Resizer',
    shortDescription: 'Resize images to any dimension online',
    description: 'Resize images to any width and height online for free. Maintain aspect ratio or set custom dimensions.',
    category: 'image',
    tags: ['resize', 'image', 'dimension', 'scale'],
    keywords: ['resize image online free', 'change image size', 'image dimensions'],
    icon: 'Maximize',
  ...
  },
  {
    ...
    description: 'Generate MD5, SHA-1, SHA-256, and SHA-512 cryptographic hashes online for free.',
    category: 'security',
    tags: ['hash', 'md5', 'sha256', 'sha1', 'crypto', 'security'],
    keywords: ['hash generator online', 'MD5 hash', 'SHA-256 generator'],
    icon: 'Hash',
  ...
  },
  {
    ...
    description: 'Generate Lorem Ipsum placeholder text instantly. Choose words, sentences, or paragraphs.',
    category: 'generator',
